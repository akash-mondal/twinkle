      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
            <a href="https://github.com/akash-mondal/twinkle" target="_blank" rel="noopener noreferrer" style={{ color: '#FFF', transition: 'opacity 0.2s', opacity: 0.8 }} aria-label="GitHub">
            ...
            <a href="https://discord.com/invite/RfFa2NEQnq" target="_blank" rel="noopener noreferrer" style={{ color: '#FFF', transition: 'opacity 0.2s', opacity: 0.8 }} aria-label="Discord">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
