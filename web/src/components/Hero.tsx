    ...
    <section style={{
      ...
      <div style={{
        ...
        <motion.p 
          ...
          style={{ fontSize: '15px', lineHeight: 1.5, color: '#FFFFFF', maxWidth: '460px', margin: 0, padding: '0 16px' }}
        >
